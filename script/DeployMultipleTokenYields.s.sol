...
contract DeployMultipleTokenYieldsScript is Script {
    ...
    function run() external {
        ...
        protocols[0].tokens[5] = TokenInfo("AqLend Staked BNB", "aBNB");
        ...
        protocols[1].tokens[5] = TokenInfo("BqLend Staked BNB", "bBNB");
        ...
        protocols[2].tokens[5] = TokenInfo("CqLend Staked BNB", "cBNB");
